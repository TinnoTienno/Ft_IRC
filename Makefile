...
#    Updated: 2024/12/21 16:58:00 by noda             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		=	main.cpp\
				...
				$(addprefix $(COMMAND_PATH), Nick.cpp Kick.cpp Join.cpp UserHost.cpp Ping.cpp PrivMsg.cpp Notice.cpp Part.cpp Topic.cpp)
